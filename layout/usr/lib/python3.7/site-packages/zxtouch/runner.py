        ...
        try:
            for idx in range(start_idx, len(plan.steps)):
                ...
                if not ok:
                    ...
                    self.job_manager.stop(job_id, "HUNG", lease_manager=lease_manager)
                ...
                if not success:
                    self.job_manager.stop(job_id, "FAILED", lease_manager=lease_manager)
            ...
            self.job_manager.stop(job_id, "FINISHED", lease_manager=lease_manager)
