...
class ProgressSnapshot:
    ...
    @classmethod
    def from_state(cls, state: Any) -> "ProgressSnapshot":
        plan_id = state.plan.plan_id if state.plan else ""
        return cls(
            plan_id=plan_id,
            current_step_id=state.current_step_id,
            step_status=state.step_status,
            budgets_used=state.budgets_used,
            started_at=state.timestamps.get("started_at", ""),
            updated_at=state.timestamps.get("updated_at", ""),
        )
