...
from .telemetry import ProgressSnapshot, TelemetryStore
...
class DaemonCore:
    ...
    def handle_progress(self) -> Dict[str, Any]:
        snapshot = ProgressSnapshot.from_state(self.job_manager.state)
        return ProgressResponse(**snapshot.to_dict()).to_dict()
